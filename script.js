...
mainbox.style.backgroundColor = "whitesmoke ";
mainbox.style.margin = "auto";
mainbox.style.marginTop = "100px";
mainbox.style.flex="auto";
...
var button_zero_zero = createbutton ('zero-zero' , '0 0');
